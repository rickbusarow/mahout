...
import com.rickbusarow.mahout.libs.CatalogSection.AliasToValue
...
internal object TestLibData {
  val versions = CatalogSection(
    listOf(
      ...
      AliasToValue("rickBusarow.mahout", "0.1.0-SNAPSHOT"),
  ...
  val plugins = CatalogSection(
    listOf(
      ...
      AliasToValue("mahout.composite", "com.rickbusarow.mahout.composite"),
      AliasToValue("mahout.java.gradle.plugin", "com.rickbusarow.mahout.java-gradle-plugin"),
      AliasToValue("mahout.kotlin.jvm", "com.rickbusarow.mahout.jvm-module"),
      AliasToValue("mahout.kotlin.multiplatform", "com.rickbusarow.mahout.kotlin-multiplatform"),
      AliasToValue("mahout.root", "com.rickbusarow.mahout.root"),
