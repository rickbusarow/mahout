...
public abstract class DetektConventionPlugin : Plugin<Project> {
  override fun apply(target: Project) {
    ...
    target.tasks.withType(Detekt::class.java).configureEach { task ->
      ...
      val generated by target.layout.buildDirectory.dir("generated")
      task.exclude { it.file.startsWith(generated.asFile) }

      task.dependsOn(target.tasks.withType(MahoutCodeGeneratorTask::class.java))
    }
