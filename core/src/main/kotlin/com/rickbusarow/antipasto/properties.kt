 ...
 */
inline fun <reified T> Project.prefixedPropertyOrNull(name: String): T? {
 ...
 */
inline fun <reified T> Project.prefixedProperty(name: String): T {
 ...
 */
val Project.commonPropertyPrefix: String
