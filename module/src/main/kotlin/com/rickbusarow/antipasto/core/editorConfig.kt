...
internal fun editorConfig(editorConfigFile: File): EditorConfig {
 ...
 */
internal fun Project.editorConfigKotlinProperties(): Map<String, String> {
 ...
 * the right of the '='. Note that every value is a String, including.
 */
internal fun editorConfigKotlinProperties(
